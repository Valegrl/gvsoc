...
#define ARCH_NUM_CORE_PER_CLUSTER 16
#define ARCH_NB_CORES_PER_TILE 4
#define ARCH_NB_SUB_GROUPS_PER_GROUP 1
#define ARCH_NB_GROUPS 4
#define ARCH_BANK_FACTOR 4
#define ARCH_AXI_DATA_WIDTH 32
#define ARCH_NB_AXI_MASTERS_PER_GROUP 1
