...
class FlexClusterArch:
    ...
    def __init__(self):
        ...
        # Outstanding AXI bursts the DMA can hold. A burst slot is occupied for the
        # whole round trip, so this times the burst size is the in-flight window.
        ...
        self.redmule_regs                = 0
        self.redmule_queue_depth         = 0
        self.redmule_stream_loads        = False
        self.redmule_row_refill_cyc      = 0
